...
namespace config
{
	...
	// map
	const short	MAP_SIZE = 12; // in task: 50
	...
	const short NUMBER_OF_COINS = MAP_SIZE * 2; // in task: 100
	...
	const short NUMBER_OF_DIAMONDS = MAP_SIZE / 5; // in task: 10
	...
	const float SUN_AND_MOON_ANIMATION_LENGTH = 10;
